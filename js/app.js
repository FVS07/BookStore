...
var libros=[
   {
    ...
    },
    {
     ...
     "autor": "Fer venzor",
     "editorial": "azkaban",
     "descripcion": "El gato negro es un cuento de horror del escritor estadounidenseEl gato negro es un cuento de horror del escritor estadounidenseEl gato negro es un cuento de horror del escritor estadounidense Edgar Allan Poe, publicado en el periódico Saturday Evening Post de Filadelfia en su número del 19 de agosto de 1843.",
     "img": "img/1.jpg"
    }
];
app.controller('LibrosController', function(){
    this.l=libros; 
